...
import { Home, Eye, EyeOff, Mail, Lock, User } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm leading-none">
                  I agree to the{" "}
                  <Link to="/terms" className="text-teal-500 hover:text-teal-600 story-link">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-teal-500 hover:text-teal-600 story-link">
                    Privacy Policy
                  </Link>
                </Label>
              </div>
